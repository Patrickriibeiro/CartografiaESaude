...
- **Escalas não entregues.** A região de saúde e a padronização por idade ficaram para uma
  fase seguinte; a comparação entre municípios de estrutura etária diferente é bruta.
