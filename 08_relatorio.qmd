...
- **Agrupamentos de zeros.** Zero caso num município pequeno pode ser ausência de notificação ou
  de testagem, e não de doença; é por isso que a taxa bruta, que forma agrupamentos desses
  zeros, é só sensibilidade.
...
- **Padronização por idade não entregue.** Ficou para uma fase seguinte; a comparação entre
  municípios de estrutura etária diferente é bruta.
