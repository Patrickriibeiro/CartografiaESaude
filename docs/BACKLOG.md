...
| ID | Título | Evidência | Modelo · Esforço | Aceite |
|---|---|---|---|---|
| CS-025 | **CI no GitHub Actions — aguardando a 1ª execução em repositório público** *(auditoria: no Windows, clonar em caminho curto; o bootstrap do `renv` falha acima de ~150 caracteres, README avisa)* — workflow escrito e validado; a 1ª execução (run 36170698073, 2026-09-25) não começou porque o GitHub recusou o job por cobrança da conta em repositório privado. Em 2026-09-25 o repositório ficou público (CS-026), e o Actions é gratuito em repositório público | `docs/release-history/cs-025-integracao-continua.md`; aba Actions do repositório | Opus · low | 1ª execução verde, < 10 min, 6 testes pulados |
