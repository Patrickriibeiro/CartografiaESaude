...
| CS-020 | **Exportação para planilha** — `salvar_resultado()` (UTF-8 com BOM, `;`, `,`) e `escrever_carimbo()`; 4 CSV + LEIA-ME em `resultados/tabelas/exportacao/`; 17 expectativas | 2026-09-25 | `docs/release-history/cs-020-exportacao.md` · commit PENDENTE |
