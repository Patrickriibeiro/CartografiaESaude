...
| CS-025 | **CI no GitHub Actions** — 1ª execução verde depois que o repositório ficou público: run 36200764263, 1 min 55 s, 553 expectativas em 21 arquivos, 6 pulados (dados reais fora da CI); badge do README ativo | 2026-09-25 | `docs/release-history/cs-025-integracao-continua.md` · commit `(a registrar)` |
