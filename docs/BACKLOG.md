...
| CS-021 | **Painel Shiny + leaflet** — agente × ano × camada, popup com 6 campos, 3 estados, instáveis tracejados; `testServer` em 24 estados; carga em 2 s. Não aberto no navegador embutido (permissão negada): inspeção visual fica com o dono | 2026-09-25 | `docs/release-history/cs-021-painel.md` · commit PENDENTE |
