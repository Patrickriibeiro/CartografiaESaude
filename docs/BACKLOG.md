...
| CS-047 | **Revisão dos modelos de gráfico** — `docs/revisao-graficos.md` com pergunta, decisão e motivo por figura (15 + 2); trocadas: eixo duplo das não encerradas → 2 painéis, rótulos sobrepostos do mapa LISA retirados; nova: série do estado com um painel por vírus. Suíte 741/741 em 23 arquivos | 2026-09-26 | `docs/release-history/cs-047-revisao-graficos.md` · commit `(a registrar)` |
