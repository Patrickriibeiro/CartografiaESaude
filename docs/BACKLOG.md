...
| CS-052 | **ADRs integrados ao texto** — seção "Decisões de método" no relatório com os 7 ADRs em linguagem de artigo (o quê, por quê, alternativa descartada; números do pipeline); proposta v2 ganha ADR-0005 e ADR-0007 no texto e a tabela de rastreio §3.11; teste garante que todo ADR é citado nos dois textos. Suíte 757/757 em 23 arquivos | 2026-09-26 | `docs/release-history/cs-052-adrs-no-texto.md` · commit `1a1a98e` |
