...
| CS-019 | **Mapas** — `mapa_incidencia()`, `mapa_lisa()` (9 categorias, dois níveis, hachura nos instáveis, confirmados nomeados), `tema_mapa()`, `hachurar()`; 12 + 12 PNG a 300 dpi e 2 painéis 3 × 4; inspeção visual pegou 2 defeitos que os testes não pegavam | 2026-09-25 | `docs/release-history/cs-019-mapas.md` · commit PENDENTE |
