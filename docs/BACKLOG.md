...
| CS-050 | **Mapa de referência das regiões de saúde** — 92 municípios coloridos pela região, nomes no polo de inacessibilidade; tabela região → municípios e população no relatório e exportada; parágrafo "por que regiões" (Decreto nº 7.508/2011; SES-RJ) e "por que a análise principal é municipal". Suíte 695/695 em 22 arquivos | 2026-09-26 | `docs/release-history/cs-050-mapa-regioes.md` · commit `(a registrar)` |
