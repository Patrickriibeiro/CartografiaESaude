...
| CS-046 | **Paleta única por vírus** — SARS-CoV-2 amarelo, influenza magenta, VSR verde em todos os gráficos; rampa de incidência por vírus; LISA vermelho/azul/roxo/cinza sem cor de vírus (antes 3 cores com dois significados, distância 0); constantes só em `funcoes_mapas.R`, teste impede cor escrita à mão; guia de cores no relatório. Suíte 683/683 em 22 arquivos | 2026-09-26 | `docs/release-history/cs-046-paleta-unica.md` · commit `(a registrar)` |
