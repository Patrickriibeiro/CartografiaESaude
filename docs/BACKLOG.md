...
| CS-048 | **Quanto os números mudam depois do fim do ano** — 19 versões antigas do banco de 2025 e 1 de 2024 achadas no S3 do portal; 6 + 1 comparadas com as do estudo: 2025 varia no máximo 3 casos por vírus (0,09 %) entre 65 e 254 dias após o fim do ano; 2024 idêntico entre 180 e 450 dias; tempo mediano até encerrar 15–22 dias, 85–93 % em até 90 dias; seção, tabela e figura no relatório. Suíte 717/717 em 22 arquivos | 2026-09-26 | `docs/release-history/cs-048-versoes-do-banco.md` · commit `b184af1` |
